  ...
  fetch("./data.json")
    ...
    .then(function (data) {
      ...
      for (let i = 0; i < data.length; i++) {
        ...
        previousTime =
          previousTime == 0 ? previousTime + "hr" : previousTime + "hrs";
        ...
        item.querySelector(".card-infor__current-status").innerHTML =
          curentTime;
...
// set onclick event to trigger change data
